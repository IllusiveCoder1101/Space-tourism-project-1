    ...
    <>
      ...
      <div className="crew" >
        ...
        <div className="imgcont">
          ...
          <img src={`image-${Record.crew[ctr].first}-${Record.crew[ctr].second}.png`}  
          alt={`${Record.crew[ctr].first} ${Record.crew[ctr].second}`} className="imgcrew"/>
        ...
        <div className="crewdesc">
          <div className="btns">
            ...
            onClick={()=>{setCtr(0)}} 
            className={(ctr===0)?"slider0 act":"slider0"}></button>

            <button type="button" disabled={(move)?true:false} 
            onClick={()=>{setCtr(1)}} 
            className={(ctr===1)?"slider1 act":"slider1"}></button>

            <button type="button" disabled={(move)?true:false} 
            onClick={()=>{setCtr(2)}} 
            className={(ctr===2)?"slider2 act":"slider2"}></button>

            <button type="button" disabled={(move)?true:false} 
            onClick={()=>{setCtr(3)}} 
            className={(ctr===3)?"slider3 act":"slider3"}></button>
