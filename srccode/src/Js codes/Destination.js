...
import '../css styles/destinations.css'
    ...
    <>
      ...
      <div className="allobj" >
        ...
        <div>
          ...
          <img src={`image-${Record.destinations[ctr].name}.png`} 
          className="planet" alt={`${Record.destinations[ctr].name}`} />
        ...
        <div className="cont">
          ...
          <section className="btns">
            ...
            className={(ctr===0)?"button0 active":"button0"} 
            onClick={()=>{setCtr(0)}}>MOON</button>

            <button type="button" disabled={(move)?true:false} 
            className={(ctr===1)?"button1 active":"button1"}  
            onClick={()=>{setCtr(1)}}>MARS</button>

            <button type="button" disabled={(move)?true:false} 
            className={(ctr===2)?"button2 active":"button2"}  
            onClick={()=>{setCtr(2)}}>EUROPA</button>

            <button type="button" disabled={(move)?true:false} 
            className={(ctr===3)?"button3 active":"button3"} 
            onClick={()=>{setCtr(3)}}>TITAN</button>
